...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/galerias/aves/aves_1.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_2.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_3.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_4.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_5.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_6.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_7.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_8.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_9.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/aves/aves_10.jpg">
    </div>
  </div>
