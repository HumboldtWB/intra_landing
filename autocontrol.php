  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>El autocontrol desde una herramienta</h3>
        
        <br><br>
        
        <p class="parrafo">
          Partiendo de la base de que la mejora viene asociada a la capacidad individual de controlar sus actividades, 
          el equipo de Auditoría Interna viene generando estrategias que permitan a las áreas o procesos hacer uso del autocontrol. 
          Para alcanzar dicho fin se han empezado a implementar herramientas como el 
          <a href="http://intranet.humboldt.org.co/tablero_seguimiento.php" target="_blank" rel="noopener noreferrer">Tablero de Seguimiento</a>  
          a las acciones de mejora que son resultado de los procesos de auditoría interna y externa.
        </p>
        <p class="parrafo">
          En el tablero pueden consultar, cuando lo requieran, las actividades abiertas, sus fechas de vencimiento y el área responsable, 
          así como aquellas acciones que ya han sido cerradas por parte de la Auditoría Interna al encontrar que las evidencias suministradas
          por los responsables son suficientes para emitir este concepto.
        </p>
        <p class="parrafo">
          Desde Auditoría seguimos avanzando en el proceso de mejorar el tablero para que éste sea un insumo que les permita agilizar las verificaciones, 
          les facilite el control y cumplimiento a los compromisos adquiridos en pro de la mejora. En este sentido, 
          sus comentarios son valiosos para avanzar en el proceso de fomento de la cultura de control.
        </p>
        <p class="parrafo">
          ¡Recuerda que el equipo del que haces parte cuenta contigo para alcanzar el éxito!
        </p>

        <p class="parrafo">
        <strong>¡No te confundas!</strong> En la hoja 1 del tablero encuentras el resultado de los hallazgos de las auditorías de la Contraloría General de la República, 
        mientras que en la hoja 2 se ubican las acciones asociadas a las no conformidades que son el resultado del ejercicio auditor interno.
        </p>
        <p class="parrafo">
          Si tienes alguna duda sobre este tema puedes contactarnos a través del correo
          <a href="mailto:auditoriainterna@humboldt.org.co">auditoriainterna@humboldt.org.co</a>
        </p>
        <img src="img/tablero.jpg" alt="" srcset="" class="d-block mx-auto">
        <p class="parrafo">
          Por: Erica Johana Pineda
        </p>
