  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <strong>Así fue nuestra primera actividad tras las remodelaciones del Venado de Oro</strong>
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/mayo/inndor_6.jpg" width="60%"><br>
        </div>
        <br>
En las instalaciones de la sede Venado de Oro se llevó a cabo la primera actividad presencial después de la llegada de la pandemia y fue el indoor de bicicletas, una actividad cuyo objetivo fue generar un espacio de reencuentro con nuestros compañeros, dar a conocer las nuevas instalaciones de la sede e incentivar la actividad física entre los trabajadores.
        <br><br>
		<div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/mayo/inndor_1.jpg" width="60%">
        </div>
        <br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/mayo/inndor_2.jpg" width="60%">
        </div>
        <br>
Desde el mediodía fueron llegando los participantes que se animaron a hacer la carrera más rápida y que compitieron inicialmente en la modalidad de 900 metros en ascenso, de la que resultaron los ocho finalistas de la competencia: Julián Torres (2:15.09), Bryan Ramírez (2:35.50), Vladimir Sandoval (2:37.30), Óscar Gualdrón (2:44.17), Andrés Peña (3:00.96), Angie Alvarado (3:07.85), Jessica Nieto (3:16.33) y Ómar Lagos (3:19.89).
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/mayo/inndor_3.jpg" width="60%">
        </div>
        <br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/mayo/inndor_4.jpg" width="60%">
        </div>
        <br>
        Este torneo marcó el inicio de una serie de actividades planeadas por Gestión Humana que buscan fortalecer los lazos entre los equipos y darle la bienvenida a los trabajadores a los nuevos espacios que ha dispuesto el Instituto para la co-creación y que hacen parte del Plan Maestro de Infraestructura (PMI).
        <br><br>
        <div style="text-align: center; font-size:11px">
        <img src="img/noticias/2021/mayo/inndor_5.jpg" width="60%">        </div>
        <br>
        <div style="text-align: center; font-size:11px">
        <img src="img/noticias/2021/mayo/inndor_7.jpg" width="60%">        </div>
		<br><br>
        La prueba final consistió en 2.5 kilómetros de recorrido en varias modalidades. Julián Torres defendió su primera victoria y consiguió el primer lugar de la competencia, seguido de Andrés Peña y Ómar Lagos. Los premios se repartieron de la siguiente manera: <br><br>
- Tercer lugar: bono de $100.000 en 14 Ochomiles <br>
- Segundo lugar: bono de $200.000 en 14 Ochomiles <br>
- Primer lugar: bono de $300.000 en 14 Ochomiles <br>
        <br>
        <div style="text-align: center; font-size:11px">
        <img src="img/noticias/2021/mayo/inndor_8.jpg" width="60%">        </div>
        <br>
        <div style="text-align: center; font-size:11px">
        <img src="img/noticias/2021/mayo/inndor_9.jpg" width="60%">        </div>
        <br>
¡Felicitamos a los ganadores de este primer torneo y los invitamos a seguir participando en nuestras actividades!   
        <br><br>
        <div>
            <div>                         
                <div>
                 	<div class="media-wrapper" align="center">
                 		<video src="torneo.mp4" poster="img/noticias/2021/mayo/inndor_9.jpg" width="924" height="582" controls>
                		</video>
            		</div>
                </div>
            </div>
