  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Conozcamos a Eduardo Tovar</h3>
        <br>
        
        <div class="text-center">          
          <video width="600" height="400" poster="img/entrevistas/eduardo-tovar.jpg" controls>
            <source src="videos/Conozcamonos-EduardoTovar.mp4"  type="video/mp4" >            
