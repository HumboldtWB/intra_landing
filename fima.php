  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>El Instituto Humboldt en FIMA, investigación con propósito</h3>
        
        <br><br>
        <div class="slide-noticia">
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/fima/fima1.jpeg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/fima/fima2.jpeg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/fima/fima3.jpeg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/fima/fima4.jpeg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/fima/fima5.jpeg" alt="" class="img-fluid">
            </div>
          </div>
        </div>
        <p class="parrafo">
          Del 30 de septiembre al 2 de octubre en el pabellón 6 de Corferias, el Instituto Humboldt dio a conocer a los asistentes de la 
          Feria Internacional del Medio Ambiente (FIMA), las publicaciones que hacen parte del trabajo investigativo de nuestros colaboradores. 
        </p>
        <p class="parrafo">
        Durante los días de exposición se entregaron distintos ejemplares a público interesado en los temas del Instituto, entre ellos biólogos, 
        ingenieros ambientales, docentes, estudiantes, trabajadores sociales y emprendedores de proyectos medioambientales. 
        Estos ejemplares fueron distribuidos para motivar la investigación y convertirnos en referente de consulta para otras 
        personas y entidades. Los temas principales fueron páramos, gobernanza y claves de gestión.
        </p>
        <p class="parrafo">
        Adicionalmente, el 1 de octubre se llevó a cabo, en el marco de la feria, un conversatorio para dar a conocer el 
        Reporte Bio 2020, un trabajo que reúne investigaciones sobre biodiversidad en Colombia. Este trabajo incluye datos de 
        flora y fauna que año tras año se actualizan en el Sistema de Información sobre Biodiversidad en Colombia – SIB.
        </p>
        <div class="text-center">          
          <video width="600" height="400" controls>
            <source src="img/noticias/2021/octubre/fima/fima.mp4" type="video/mp4">            
