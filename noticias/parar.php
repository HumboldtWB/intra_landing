  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Parar para respirar, una iniciativa del Instituto para fortalecer los lazos entre los colaboradores </h3>
        
        <br>
        <p class="parrafo" style="text-align: center;">
          <i>El área de bienestar abre un nuevo espacio de esparcimiento</i>
        </p>

        <p class="parrafo">
          Te invitamos a participar en #Pararpararespirar, un espacio organizado por el área de Bienestar del Instituto, que se llevará a cabo una vez al mes en donde todos podrán participar y tener un espacio de esparcimiento, relacionamiento y disfrute para retomar nuestras tareas diarias con más energía y motivación.
        </p>
        <p class="parrafo">
          El pasado 24 de enero realizamos el primer encuentro en la sede Venado de Oro, allí compartimos unas onces y disfrutamos con  juegos de mesa.  
        </p>

        <div class="row py-5">
          <div class="col-md-6">
            <img src="../img/noticias/2022/Pararparacompartir.jpg" alt="" class="img-fluid">
          </div>
          <div class="col-md-6">
            <img src="../img/noticias/2022/Pararparacompartir-2.jpg" alt="" class="img-fluid">
          </div>
        </div>

        <p class="parrafo">
          Te invitamos al próximo encuentro para que nos acompañes y disfrutes un momento diferente, si quieres asistir inscríbete 
          <a href="https://forms.office.com/Pages/ResponsePage.aspx?id=DQSIkWdsW0yxEjajBLZtrQAAAAAAAAAAAAO__Z0NjHVUQVBCTDRRU01DUkpSRFlPWFNWSUZIUkdMQi4u" target="_blank" rel="noopener noreferrer">AQUÍ</a>.
          <br>
          ¡Te esperamos!
