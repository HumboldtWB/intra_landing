  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Decálogo de la biodiversidad</h3>
        
        <br>
        
        <p class="parrafo">
          En el contexto de cambio de Gobierno nacional, el Instituto Humboldt preparó un Decálogo por la biodiversidad 2022-2026, con 10 mensajes fuerza, 
          sus respectivas propuestas de acción y las contribuciones que viene realizando el Instituto en cada uno de estos temas, a 
          través de sus múltiples equipos de investigación. Esperamos que este documento, de libre circulación, sea una herramienta para 
          el diálogo institucional y un referente para las apuestas en biodiversidad del próximo Plan Nacional de Desarrollo.
        </p>
        <p class="parrafo">
          Para más información, puedes contactar a la Oficina de Asuntos Internacionales, Política y Cooperación, al correo <a href="mailto:mrocha@humboldt.org.co">mrocha@humboldt.org.co</a>.
        </p>
        <p class="parrafo">
          Puedes <a href="http://humboldt.org.co/images/documentos/DECALOGO-DE-LA-BIODIVERSIDAD.pdf" target="_blank" rel="noopener noreferrer">ver el dacálogo aquí</a>
        </p>
