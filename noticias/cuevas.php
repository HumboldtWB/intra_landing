  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Proteger los ecosistemas kársticos del país</h3>
        
        <br>
        
        
        <div style="display: block; width:65%;margin:0 auto">
          <iframe src="https://drive.google.com/file/d/1LC3h8YTyQlYaeSZerc9L_tcNivawVZyO/preview" frameborder="0" width="100%" height="460" ></iframe>
        </div>
        
        <p class="parrafo">
        Carlos Lasso, investigador del Programa de Ciencias Básicas de la Biodiversidad, resalta la importancia de la aprobación del proyecto de ley que busca proteger los ecosistemas kársticos del país.
        </p>
