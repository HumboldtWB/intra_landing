  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Iniciativas Humboldt</h3>
        
        <br>
        
        <p class="parrafo">
          <strong>Club de Lectura</strong> <br>
          ¿Quieres comentar e intercambiar tus opiniones sobre libros o publicaciones de interés?
          Únete al club y asiste a sus reuniones periódicas. <br>
          Si quieres conocer más sobre esta iniciativa, contáctate con: <br>
          Natalia Norden Medina - nnorden@humboldt.org.co <br>
          Horario: <br>
          Viernes cada 15 días  <br>
          4:00 p.m. a 6:00 p.m.  <br>
          <a href="https://calendar.google.com/event?action=TEMPLATE&tmeid=N2VnazZuM2g5b2t1aGZocTd1aW5jamNnMGtfMjAyMjA5MDJUMjEwMDAwWiBsbW9yYUBodW1ib2xkdC5vcmcuY28&tmsrc=lmora%40humboldt.org.co&scp=ALL" target="_blank" rel="noopener noreferrer">Clic AQUÍ para agregar este evento a tu calendario </a>
        </p>
        ...
        <p class="parrafo">
          ...
          <a href="https://calendar.google.com/event?action=TEMPLATE&tmeid=NjNrYnI4MThyMnM5Z3YwcWVqdnYwcDdyZ3BfMjAyMjA3MjlUMjEwMDAwWiBsbW9yYUBodW1ib2xkdC5vcmcuY28&tmsrc=lmora%40humboldt.org.co&scp=ALL" target="_blank" rel="noopener noreferrer">Clic AQUÍ para agregar este evento a tu calendario</a>  
        </p>

        <p class="parrafo">
          <strong>Grupo de Género y Equidad</strong> <br>
          Únete a este espacio para compartir historias y pensar cómo hacer del Instituto y nuestros mundos más allá del trabajo, lugares un poco más cuidadosos y justos, más polifónicos, donde se oigan igual de claras y seguras las voces de todos. 
          Si quieres conocer más sobre esta iniciativa, contáctate con: <br>
          Ana Belén Hurtado - ahurtado@humboldt.org.co
        </p>

        <p class="parrafo">
          Si deseas que tu iniciativa aparezca en esta sección, por favor envíanos toda la información al correo <a href="mailto:comunicacionesinternas@humboldt.org.co">comunicacionesinternas@humboldt.org.co</a>
        </p>
