  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Participación del Instituto en el Inventario Forestal Nacional</h3>
        
        <br>
        
        
        <div style="display: block; width:65%;margin:0 auto">
          <iframe src="https://drive.google.com/file/d/16aRWKwUav1hBKs2X94ubgFrV8ZkGo4Hz/preview" frameborder="0" width="100%" height="420" ></iframe>
        </div>
