  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Ejercicio de restauración en la sede del Venado de Oro</h3>
        
        <br>
        
        
        <div style="display: block; width:65%;margin:0 auto">
          <iframe src="https://drive.google.com/file/d/1mFYlrbEkSXqab0P1IZh_lO0SPF-Fk-Rg/preview" frameborder="0" width="100%" height="420" ></iframe>
        </div>
