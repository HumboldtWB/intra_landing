  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>GALERÍA - COLECCIÓN DE TEJIDOS EN PALMIRA</h3>
        <br>
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos1.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos2.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos3.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos4.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos5.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos6.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos7.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos8.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos9.png">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/tejidos/tejidos10.png">
    </div>
  </div>
