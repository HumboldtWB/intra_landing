  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Conoce sobre la visita del Reino Unido al Instituto Humboldt</h3>
        
        <br><br>
        <div class="slide-noticia">
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/visita/CAN02455_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/visita/CAN02472_ (1).jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/visita/CAN02479_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/visita/CAN02485_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/visita/CAN02503_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/visita/CAN02544_ (1).jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/visita/CAN02595_ (1).jpg" alt="" class="img-fluid">
            </div>
          </div>
        </div>
        <p class="parrafo">
          El pasado 7 de octubre el Instituto Alexander von Humboldt recibió la visita de Lord Zac Goldsmith, ministro de Ambiente de 
          Reino Unido y otras personalidades para discutir los retos y oportunidades en materia de bioeconomía y fortalecer la cooperación entre Colombia y Reino Unido. 
        </p>
        <p class="parrafo">
          La delegación que nos visitó en la sede Venado de Oro incluyó al embajador del Reino Unido en Colombia, Collin Martin Reynolds, 
          al embajador de Colombia en el Reino Unido, Antonio José Ardila, a la responsable de la organización de la COP26 en cambio climático, 
          Fiona Clouder y a otros funcionarios de la Embajada del Reino Unido en Colombia. 
        </p>
        <p class="parrafo">
          Este encuentro inició con una actividad que incluyó la grabación de sonidos de Chiribiquete, una pieza que reúne la riqueza sonora del Amazonas, 
          cuyo fin era transportar a nuestros invitados a una de las regiones más diversas de nuestro país. 
        </p>
        <p class="parrafo">
          Posteriormente nuestro director, Hernando García, el subdirector de Investigaciones, Óscar Gualdrón y la jefe de la Oficina de Asuntos Internacionales, 
          Política y Cooperación, Sandra Perdomo, desarrollaron una conversación bilateral con la delegación, donde se dio a conocer el Instituto Humboldt 
          como el Instituto Nacional de Biodiversidad de Colombia, comprometidos con la construcción de conocimiento sobre la biodiversidad del 
          país y sus contribuciones a la sociedad, así como con los cambios transformativos necesarios para detener el ritmo acelerado de 
          pérdida de biodiversidad y alcanzar el desarrollo sostenible. 
        </p>
        <p class="parrafo">
          En un segundo momento la reunión involucró a representantes de otras entidades, incluyendo a Nicolás Galarza, viceministro de Medio Ambiente, 
          Luz Marina Mantilla, directora de SINCHI, Sergio Cristancho, viceministro de Conocimiento, Innovación y Productividad, Santiago Aparicio, 
          director de Ambiente y Desarrollo Sostenible del Departamento Nacional de Planeación, Camilo Younes, vicerrector de Investigación 
          de la Universidad Nacional de Colombia y Sara Vera, gerente de Internacionalización y Relaciones Institucionales de la EAN. 
          Por parte del Instituto contamos además con la participación y apoyo de Felipe García, coordinador de Ciencias Básicas, Diego Ochoa, 
          jefe de la Oficina de Comunicaciones del Instituto y algunos colaboradores de esta oficina y la Oficina de Asuntos Internacionales, Política y Cooperación.  
        </p>
        <p class="parrafo">
          El objetivo de la conversación con estas entidades fue el intercambio de experiencias sobre el rol de las instituciones en la bioeconomía colombiana, 
          así como la identificación de oportunidades y retos relacionados con este tema. En este sentido, el Instituto Humboldt resaltó la importancia de la 
          bioeconomía para el desarrollo, la competitividad y la sostenibilidad del país y sus comunidades, siempre bajo la mirada de la conservación y el uso 
          sostenible de la biodiversidad. 
        </p>
        <p class="parrafo">
          También se resaltó la importancia de la bioeconomía en épocas de recuperación post pandemia, adaptación al cambio climático, la promoción del 
          uso sostenible de recursos forestales no maderables que conllevan a la protección de los bosques y la participación de otros sectores y 
          su corresponsabilidad frente a la protección de la biodiversidad.
        </p>
        <p class="parrafo">
          La delegación de Reino Unido resaltó al final de la visita el sentido de pertenencia y servicio de los colaboradores que hicieron parte de este encuentro 
          y la belleza de la sede Venado de Oro, insignia del Instituto. 
        </p>
        <p class="parrafo">
          <b>Por: Juanita Chaves</b>
        </p>
