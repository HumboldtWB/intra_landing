  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Evento Volleyball</h3>
        
        <br><br>
        
        <br>

        <iframe src="https://drive.google.com/file/d/1aSDYTLkN51WBWK9PBLHa3zZJNO1ZNOvx/preview" frameborder="0" width="80%" height="600" style="display:block;margin:0 auto" ></iframe>
        ...
        <div class="slide-noticia">
          ...
          <div>
            <div class="img-container">
              <img src="img/galerias/volley/1.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/volley/2.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/volley/3.jpg" alt="stand" class="img-fluid">
            </div>
          </div>      
          <div>
            <div class="img-container">
              <img src="img/galerias/volley/4.jpg" alt="stand" class="img-fluid">
            </div>
          </div>    
