        ...
        <div class="slide-noticia">
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/g1.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/g2.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/g3.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/g4.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/g5.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/g6.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/1.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/2.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/3.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/4.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/humfest/5.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
