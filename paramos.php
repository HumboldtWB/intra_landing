  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Campaña radial Expedición Páramos</h3>
        <br><br>
El Instituto Humboldt apoya la iniciativa de Caracol Radio y Bavaria de recorrer algunos páramos de Colombia para explicar de forma sencilla y entretenida el valor estratégico de estos ecosistemas para los colombianos. A través de un recorrido por los páramos de Almorzadero, Chingaza, Guerrero, Sumapaz, Guantiva La Rusia y Santurbán, Caracol Radio muestra las maravillas naturales de estos ecosistemas de alta montaña y las personas que los habitan.
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/paramos_1.png" width="60%">
        </div>
        <br>
Caracol Radio despliega a sus periodistas y el Instituto Humboldt a sus investigadores para resaltar la importancia de los páramos y las acciones de conservación y protección.
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/paramos_2.png" width="60%">
        </div>
        <br>
        Conozca de primera mano a través de nuestra investigadora Amalia Díaz qué es un frailejón:
        <br>
        <a href="https://caracol.com.co/radio/2021/07/27/nacional/1627381214_259251.html" style="color:#0000FF !important" target="_blank">Caracol.com.co</a>
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/paramos_3.png" width="60%">
        </div>
        <br>
        Para conocer la expedición y los programas visite:
        <br>
        <a href="https://caracol.com.co/agr/expedicion_paramo/a/">Expedición paramo</a>
        <br><br>
        ¡Estén atentos para una rifa de un morral de la expedición!
        <br>
        <br>
