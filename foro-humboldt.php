    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-12 prologo">
          <div style="background-color: #93BF1F; color: #ffffff!important; padding:5px; margin: 0px; margin-bottom:20px">
                    &nbsp;&nbsp;&nbsp;FORO HUMBOLDT
                  </div>
        <a href="landing.php"><strong>&#x2b60; Volver</strong></a><br><br>
        <div class="encuensta" style="margin-top:10px">
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfn0GfuS2qzbvu7diCQ7kefRMYJ8vPuyoVUctABRd-8diPJ5A/viewform?embedded=true" width="100%" height="1300" frameborder="0" marginheight="0" marginwidth="0">Cargando…</iframe>
          <br>
          
          <!-- COMENTARIOS FACEBOOK -->
          <div class="fb-comments" data-href="http://humboldt.org.co/prueba_intranet/foro-humboldt.html" data-width="100%" data-numposts="15" data-colorscheme="light" data-mobile="false" data-order-by="reverse_time"></div>
          </div>
          <!-- FIN COMENTARIOS FACEWBOOK-->
