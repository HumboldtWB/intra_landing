  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Expedición Montes de María</h3>
        ...
        <div class="slide-noticia">
          <div>
            <div class="img-container2">
              <img src="img/galerias/montes/1.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/montes/2.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/montes/3.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/montes/4.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/montes/5.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
