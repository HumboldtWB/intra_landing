  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Cartilla Otras Medidas Efectivas de Conservación Basadas en Áreas (OMECs)</h3>
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/cartilla_1.png" width="60%"><br>
        </div>
        <br>
Se llevó a cabo el lanzamiento de la cartilla Otras Medidas Efectivas de Conservación Basadas en Áreas (OMECs): Guía para su Identificación, Fortalecimiento y Reporte en Colombia, en el marco del “Proyecto Adaptación de los criterios OMEC al contexto colombiano”, liderado por Resnatur, el Instituto Humboldt, la Fundación Natura y el Proyecto Áreas Protegidas Locales (GIZ, ICLEI y UICN), con el apoyo del Programa de Pequeñas Donaciones del GEF -PNUD.
        <br><br>
		<div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/cartilla_2.png" width="60%">
        </div>
        <br>
Esta guía presenta una metodología sencilla y práctica para identificar, en el contexto colombiano, si las múltiples iniciativas de conservación y uso sostenible de la biodiversidad gestionadas por las comunidades étnicas y locales, la sociedad civil, las entidades públicas o privadas y las administraciones municipales cumplen con los criterios y pueden catalogarse como OMEC. Abarca temas de reporte e inclusión de las OMEC en la base de datos mundial que maneja el Centro Mundial de Monitoreo de la Conservación.
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/cartilla_3.png" width="60%">
        </div>
        <br>
        La guía explica el contexto internacional de las OMEC y su vinculación al ámbito colombiano; la aplicación paso a paso de los criterios, con herramientas prácticas para correrlos y evaluar los resultados; y explica qué es la base de datos mundial y cómo, desde la ruta nacional recientemente oficializada por Minambiente, se reportan las OMEC a esta base, a través de un sistema integrado de gestión.
        <br><br>
        Descargue la guía <a href="https://resnatur.org.co/apc-aa-files/db9417709e9e7148d514bb8dac11b31a/cartillaomecbook_inserto_1.pdf" style="color:#0000FF !important" target="_blank">aquí</a>
        <br>
