  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Juliana Cortés, un talento Humboldt protagonista de un reconocimiento</h3>
        
        <br><br>
        <div class="slide-noticia">
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/noviembre/ecosistema2.png" alt="premio" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/noviembre/ecosistema.png" alt="ecosistema" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/noviembre/aplicacion_lista_es.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/noviembre/perdida_ecosistema_01_es.jpg" alt="" class="img-fluid">
            </div>
          </div>
          
        </div>
        <p class="parrafo">
          La investigación <strong>Ecosistemas Colombianos: amenazas y riesgos. Una aplicación de la Lista Roja de Ecosistemas a los ecosistemas terrestres 
            continentales</strong> fue la ganadora del premio nacional 2021 sobre medio ambiente y desarrollo sostenible Camila Botero Restrepo. En esta investigación, 
          liderada por el profesor Andrés Etter, participó una de nuestras investigadoras y compañera, Juliana Andrea Cortés Rincón.
        </p>
        <p class="parrafo">
          La Lista Roja de Ecosistemas (LRE) es una herramienta que permite apoyar y orientar los esfuerzos de conservación que actualmente se realizan en el país, 
          mediante la identificación de ecosistemas que, por sus niveles de amenaza, requieren de acciones urgentes de gestión y monitoreo. 
          En esta investigación se encontró que más de la mitad de los ecosistemas se encuentra en niveles altos de riesgo, y de estos 
          la mitad se encuentra en estado crítico habiendo perdido más del 80% de su superficie.
        </p>
        <p class="parrafo">
          Algunos de los ecosistemas que se encuentran en peligro crítico (CR) son los del bioma de bosque seco tropical, 
          el bioma del desierto tropical, los ecosistemas secos intrazonales de Los Andes, los ecosistemas húmedos (algunos humedales de los departamentos de 
          Boyacá y Cundinamarca), las áreas de bosque húmedo tropical del Piedemonte Llanero, entre otros. 
        </p>
        <p class="parrafo">
          Encuentra aquí más información de la investigación: 
          <a href="https://sandbox.makinaeditorial.com/ecosistemas-colombianos/build/#/introduccion" target="_blank" rel="noopener noreferrer" class="d-block">https://sandbox.makinaeditorial.com/ecosistemas-colombianos/build/#/introduccion</a>
        </p>
        <p class="parrafo">
          Juliana Cortés es investigadora del Instituto e hizo parte de este proyecto identificando el nivel de intensidad de las amenazas a 
          los ecosistemas por sectores productivos y su relación con los niveles de riesgo, 
          apoyando la descripción del conjunto de pares de especies planta-animal que pudieran dar información sobre procesos ecológicos 
          (dispersión y polinización), que se utilizaron en el criterio D de la lista roja de ecosistemas terrestres, 
          desarrollando una descripción de algunos ecosistemas con un alto grado de amenaza y apoyando en la aplicación de la LRE en conservación 
          (áreas protegidas y otras áreas de conservación) y restauración (identificación de áreas para restauración).   
        </p>
        <p class="parrafo">
          “Es una investigación muy interesante y que aporta mucha información para la toma de decisiones a nivel regional y nacional. 
          Desde que se presentó el resultado, en el Instituto se ha utilizado en diferentes proyectos de áreas de conservación y restauración, 
          como en investigaciones de conectividad, en modelos de distribución de especies, entre otros” agregó Juliana. 
        </p>
        <p class="parrafo">
          Destacó además el honor que representó para ella trabajar y aprender del profesor Andrés Etter y consideró un verdadero privilegio trabajar 
          con grandes profesionales como Kelly Saavedra, Paulo Arévalo, Paula Amaya y Ángela Andrade, otros investigadores vinculados a la investigación.  
        </p>
