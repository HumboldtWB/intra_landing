  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>La primera cohorte de formadores de la Universidad Humboldt</h3>
        
        <br><br>
        <div class="slide-noticia">
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02325_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02348_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02353_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02355_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02358_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02365_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02370_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02372_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02374_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02377_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02381_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02387_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02393_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02399_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02413_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02425_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02430_.jpg" alt="" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/noticias/2021/octubre/formadores/CAN02431_.jpg" alt="" class="img-fluid">
            </div>
          </div>
        ...
        <p class="parrafo">
          El pasado 5 de octubre en la sede de la Calle 72 se entregaron las certificaciones que acreditan a la primera cohorte de formadores del Instituto. 
          Este proceso de formación hace parte del gran proyecto de la Universidad Corporativa.
        </p>
        <p class="parrafo">
          El objetivo fue instruir a los primeros formadores internos, quienes serán los encargados no solo de presentar los primeros programas de la universidad 
          en el 2022, sino también de formar a otros funcionarios del instituto para ser maestros o instructores dentro de la universidad en programas específicos. 
        </p>
        <p class="parrafo">
          Los formadores tienen la misión de acompañar la construcción y mejora continua del instructivo para la creación de los programas formativos 
          de la Universidad. Este curso de 36 horas los capacitó para asumir el reto de ser los primeros formadores dentro de la Universidad Corporativa y 
          les dio algunas herramientas pedagógicas como: comunicación para formar, recursos y dispositivos, aprendizaje ágil, diseño y 
          mantenimiento de una marca personal, socialización y diagnóstico, entre otras.  
        </p>
        <p class="parrafo">
          Los funcionarios que se certificaron fueron: 
        </p>
        <ul>
          <li>
        ...
        <p class="parrafo">
          Felicitamos a nuestros formadores y les deseamos muchos éxitos en el reto que inicia próximamente y nos beneficiará a todos como equipo Humboldt.
        </p>
        <p class="parrafo">
          <b>#YoPropongo</b>
        </p>
