  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Colección de Tejidos del Instituto Humboldt, el custodio de riqueza natural</h3>
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/septiembre/tejidos8.png" width="60%"><br>
        </div>
        <br>
En el Valle del Cauca, cerca de donde crecen los cañaduzales, se encuentra un laboratorio lleno de historia, el mismo donde se guardan muchos años de trabajo de nuestros investigadores con las muestras de tejidos que se recolectan y conservan en los espacios del Centro Internacional de Agricultura Tropical (CIAT). Allí se encuentra la Colección de Tejidos del Instituto Humboldt.
<br><br>
Tres personas son las encargadas de custodiar y cuidar esta colección, que junto con la de Villa de Leyva es de las más grandes e importantes de América Latina. En el kilómetro 17 de la vía que conduce de Cali a Palmira se adecuó el laboratorio con toda la infraestructura necesaria y todos los elementos para conservar las muestras en óptimas condiciones.
        <br><br>
        <div class="media-wrapper">
        <video src="hg_ciat.mp4" poster="img/noticias/2021/septiembre/hg_ciat.png" width="100%" height="480" controls>
        </video>
        </div>
        <br><br>
        Estas muestras que se alojan en la sede de la Colección de Tejidos del Instituto Humboldt de Palmira están disponibles para el público en general, con el objetivo de que investigadores de todo el mundo puedan utilizarlas y encontrar en nuestro país nuevos elementos que contribuyan al desarrollo científico. 
		<br><br>
        Adicionalmente, esta sede se encuentra contemplada en el Plan Maestro de Infraestructura, que propone mejoras en el laboratorio que permitan alojar más muestras y ampliar esta valiosa colección. 
        <br><br>
        <div class="media-wrapper">
       <video src="mb_ciat.mp4" poster="img/noticias/2021/septiembre/mb_ciat.png" width="100%" height="480" controls>
        </video>
        </div>
<br><br>
Te invitamos a conocer el trabajo de nuestros compañeros en el laboratorio de  la Colección de Tejidos del Instituto Humboldt de Palmira y a reconocer estos espacios que también son parte del Instituto. Para ingresar al CIAT, puedes ponerte en contacto con el equipo de la colección al correo electrónico <u><span style="color:#00F">coleccionesbiologicas@humboldt.org.co</span></u>.
            <br><br>
            <div class="media-wrapper">
                <video src="og_ciat.mp4" poster="img/noticias/2021/septiembre/og_ciat.png" width="100%" height="480" controls>
                </video>
            </div>
            <br><br>
            ¡Te esperamos!
