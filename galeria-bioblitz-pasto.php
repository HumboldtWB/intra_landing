  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Jornada Bioblitz - Pasto</h3>
        
        <br><br>
        
        <br>

        <iframe src="https://drive.google.com/file/d/1f6H4NUo0WoCpGPPq5yewjfrY8Yl-QbIH/preview" frameborder="0" width="70%" height="600" style="display:block;margin:0 auto" ></iframe>
        ...
        <div class="slide-noticia">
          <div>
            <div class="img-container">
              <img src="img/galerias/bioblitz-pasto/IMG_20220924_062037.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/bioblitz-pasto/IMG_20220924_072458.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/bioblitz-pasto/IMG_20220924_162104.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/bioblitz-pasto/IMG_20220924_162433.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/bioblitz-pasto/IMG_20220924_164416.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/bioblitz-pasto/IMG_20220924_170215.jpg" alt="stand" class="img-fluid">
            </div>
          </div>
          
        </div>
        <p class="parrafo">
          <span style="display: block;text-align:center">Fotos por Laura Mora, Instituto Humboldt</span>
        </p>
