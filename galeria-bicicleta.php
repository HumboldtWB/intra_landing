  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Torneo de bicicleta bajo techo</h3>
        ...
        <div class="slide-noticia">
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/DSC_0570.JPG"  class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/DSC_0594.JPG" alt="stand 2" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/DSC_0601.JPG" alt="charla" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/DSC_0609.JPG" alt="aplicacion" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl1.jpeg" alt="niño usando la app" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl2.jpeg" alt="charla mujeres" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl3.jpeg" alt="expositoras" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl4.jpeg" alt="selfie con oso" class="img-fluid">
            </div>
          </div>  
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl5.jpeg" alt="Haciendo el herbario" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl6.jpeg" alt="herbarios" class="img-fluid">
            </div>
          </div>  
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl7.jpeg" alt="colecciones insectos" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl8.jpeg" alt="charla 2" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl9.jpeg" alt="charla 3" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl10.jpeg" alt="charla coleccion" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl11.jpeg" alt="charla coleccion" class="img-fluid">
            </div>
          </div>    
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl13.jpeg" alt="charla coleccion" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl14.jpeg" alt="charla coleccion" class="img-fluid">
            </div>
          </div>  
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl15.jpeg" alt="charla coleccion" class="img-fluid">
            </div>
          </div>  
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl16.jpeg" alt="charla coleccion" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container">
              <img src="img/galerias/cycling/sl17.jpeg" alt="charla coleccion" class="img-fluid">
            </div>
          </div>          
        </div>
