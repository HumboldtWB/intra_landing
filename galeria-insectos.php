  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>GALERÍA Tejido en Palmira</h3>
        <br>
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_1.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_2.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_3.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_4.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_5.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_6.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_7.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_8.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_9.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_10.jpg">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/galerias/insectos/insectos_11.jpg">
    </div>
  </div>
