    ...
    <div class="container">
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="img-container">
              <a href="documentos/convenios/coorserpark.pdf" target="_blank" rel="noopener noreferrer">
                <img src="img/noticias/convenios/coorserpark.jpg" alt="familia posando" >
              </a>
              <figcaption>
                <img src="img/noticias/convenios/Banner-Coorserpark.jpg" alt="">
              </figcaption>
            </div> 
          </div>
          <div class="col-md-6">
            <div class="img-container">
              <a href="documentos/convenios/Fincomercio.pdf" target="_blank" rel="noopener noreferrer">
                <img src="img/noticias/convenios/fincomercio.jpg" alt="fincomercio" >
              </a>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="img-container">
              <a href="documentos/convenios/convenio_colsubsidio.pdf" target="_blank" rel="noopener noreferrer">
                <img src="img/noticias/convenios/colsubsidio-2.jpg" alt="colsubsidio" >
              </a>
              <figcaption>
                <img src="img/noticias/convenios/Banner-Colsubsidio.jpg" alt="">
              </figcaption>
            </div> 
          </div>
          <div class="col-md-6">
            <div class="img-container">
              <a href="documentos/convenios/flyer-occidente.png" target="_blank" rel="noopener noreferrer">
                <img src="documentos/convenios/flyer-occidente.png" alt="asesores" >
              </a>
              <!-- <figcaption>
                <img src="img/noticias/convenios/Banner-Banco-de-Occidente.jpg" alt="">
              </figcaption> -->
            </div> 
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="img-container">
              <a href="documentos/convenios/libranza-davivienda.pdf" target="_blank" rel="noopener noreferrer">
                <img src="img/noticias/convenios/davivienda.jpg" alt="colsubsidio" >
              </a>
              <figcaption>
                <img src="img/noticias/convenios/DAVIVIENDA-INTRANET.jpg" alt="">
              </figcaption>
            </div> 
          </div>
          <div class="col-md-6">
            <div class="img-container">
              <a href="documentos/convenios/Tarifas-Premium-2023.pdf" target="_blank" rel="noopener noreferrer">
                <img src="img/noticias/convenios/sanitas.jpg" alt="sanitas">
              </a>
            </div>            
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="img-container">
              <a href="documentos/convenios/infografia de beneficios.pdf" target="_blank" rel="noopener noreferrer">
                <img src="img/noticias/convenios/bancolombia.jpg" alt="bancolombia" >
              </a>
              <!-- <figcaption>
                <img src="img/noticias/convenios/DAVIVIENDA-INTRANET.jpg" alt="">
              </figcaption> -->
        ...
        <p class="parrafo">
          Para consultar el listado de asesores en los diferentes convenios descarga el <a href="documentos/convenios/Asesores.pdf" target="_blank" rel="noopener noreferrer">siguiente listado</a>
        </p>
