    ...
    <div class="container">
      <div class="row">
        ...
        <div class="img-container">
          <img src="img/cafe-2.jpg" alt="foto grupo en oficina">
          <figcaption>Cafe cultura</figcaption>
        </div>
        
        <p class="parrafo">
          Hemos iniciado nuestras reuniones de Café Cultura, un espacio cercano, empático y constructivo para conversar de nuestra cultura institucional dándole mayor 
          profundidad a cada una de las dimensiones de la cultura objetivo.
        </p>
        <p class="parrafo">
          Ya tuvimos la segunda entrega de nuestro Café - Cultura, en esta oportunidad hablamos sobre la dimensión de Propósito al interior del instituto y nos preguntamos: 
          ¿Por qué es valioso un propósito común dentro del instituto? 
        </p>
        <p class="parrafo">
          Logramos identificar que un propósito superior nos permite ser parte de algo más grande, nos brinda la posibilidad de poder encauzar nuestros esfuerzos en pro 
          de un bien común y por supuesto por medio de él seguir construyendo nuestro propósito individual dándole sentido día a día a nuestro quehacer. 
        </p>
        <p class="parrafo">
          Ahora el camino es lograr vivir en propósito, lo cual conlleva un nivel de conciencia superior al cuestionarnos si lo que hago contribuye y 
          está en línea con mi propósito, con ello lograremos mover ese motor interno para vivir en plenitud, por otra parte, talento humano conectado 
          con su propósito le permite al instituto mayores niveles de eficiencia y productividad, en línea con su cultura organizacional para lograr las metas y retos.
        </p>
        <p class="parrafo">
          Si te interesa asistir de manera presencial al próximo Café Cultura, comunicate con Oscar Castaño al correo <a href="mailto:ocastano@humboldt.org.co">ocastano@humboldt.org.co</a>
        </p>
        

        <p class="parrafo">
          <strong>Dale un vistazo a nuestro último encuentro:</strong>
        </p>

        <div style="display: block; width:65%;margin:20px auto">
          <iframe src="https://drive.google.com/file/d/1Lai5nj1BOvyvHA_Q02zoIwB2gxCTSyVD/preview" frameborder="0" width="100%" height="420" ></iframe>
        </div>
