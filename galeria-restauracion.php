  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Evento de lanzamiento Mapa de Restauración</h3>
        ...
        <div class="slide-noticia">
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3657.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3670.jpg" alt="stand" class="img-fluid">
            </div>
          </div>          
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3673.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3690.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3691.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3700.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3710.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3714.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3727.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3731.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3749.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3772.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3788.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3790.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3806.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
          <div>
            <div class="img-container">
              <img src="img/galerias/restauracion/BAGU3825.jpg" alt="stand" class="img-fluid">
            </div>
          </div> 
        </div>
        <p class="parrafo">
          Si quieres ver el evento puedes <a href="https://www.youtube.com/watch?v=YXqdGz6Yp9o&t=40s" target="_blank" rel="noopener noreferrer">encontrarlo aquí</a>
        </p>
