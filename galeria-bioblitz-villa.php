  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Jornada Bioblitz - Villavicencio</h3>
        ...
        <div class="slide-noticia">
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/1.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/2.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/3.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/4.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/5.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/6.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/7.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/8.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/9.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/10.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
          <div>
            <div class="img-container2">
              <img src="img/galerias/bioblitz-villa/11.jpeg" alt="stand" class="img-fluid">
            </div>
          </div>
