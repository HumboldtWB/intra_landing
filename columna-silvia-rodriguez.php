        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-12 prologo">
                    ...
                    <br>
                    <h4>La importancia de la planeación en el Instituto</h4>
                    <br>
                    <h5><strong>Planeando ando…</strong></h5>
                    <br>
                    Parte fundamental del fortalecimiento de cualquier institución es, sin duda alguna, el proceso de planeación. Tal proceso, se convierte en el cimiento sobre el cual se edifican las acciones conducentes al logro de metas y cumplimiento de los objetivos institucionales.
                    <br><br>
                    Planear no es una tarea fácil, implica orden, disciplina y compromiso, lo cual, en el fondo, se traduce en un mayor esfuerzo inicial para anticiparse y determinar tanto el camino, como las acciones para lograr lo que nos proponemos.
                    <br><br>
                    La importancia de planear radica en qué invertimos el tiempo pensando y organizando la mejor forma de hacer las cosas, con miras colectivas de eficiencia y disminución de reprocesos, lo que redunda en un mejor trabajo colaborativo institucional.
                    <br><br>
                    En síntesis, la planeación es una atmósfera de trabajo, un estilo de colaboración que promueve la cultura de cumplimiento y mejora continua, lo cual, nos hace partícipes de un gran lugar de trabajo.
                    <br><br>
                    Para nuestro Instituto, la planeación se convierte en el vehículo que nos conduce a ser mejores y eficientes.
                    <br><br>
                    Por ello, ¡Planeando ando!
                    <br><br><br>
                    Silvia Rodríguez
                    <br><br>
                </div>
