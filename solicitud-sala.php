  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Mejora continua: Conoce la nueva opción para reservar salas de reunión</h3>
        
        <br><br>
        
        <p class="parrafo">
          Diariamente conocemos los logros de los investigadores del Instituto a través de sus publicaciones y los resultados de sus trabajos de campo, 
          pero hay otros méritos que a veces pasan por alto y que son pequeñas acciones que generan grandes cambios.
        </p>
        <p class="parrafo">
          Uno de los más recientes, y que seguramente aún no conoces, es la mejora en la plataforma para la reserva de salas, y es que el sistema te permite 
          ver qué salas han sido reservadas y te da la opción de conocer el aforo permitido de cada espacio para que, según la cantidad de invitados, 
          escojas el lugar idóneo para tu encuentro. 
        </p>
        <p class="parrafo">
          Desde cualquier dispositivo (computadora o móvil) podrás encontrar las opciones y hacer el proceso para elegir tu sala de reuniones. 
        </p>
        <p class="parrafo">
          Te dejamos este tutorial para que conozcas el proceso de reserva: 
        </p>

        <div class="d-block mx-auto" style="width: 100%; max-width: 50%;">
          <video width="420" height="640" controls>
            <source src="videos/Video-salas.mp4" type="video/mp4">          
            Your browser does not support the video tag.
          </video>
        </div>

        <p class="parrafo">
          Adicionalmente, podrás ver la locación, fecha y hora de las salas que ya se encuentran ocupadas. 
          ¡Felicidades a nuestro equipo de Tecnologías de la Información por el valioso esfuerzo!
        </p>
        <p class="parrafo">
          <img src="img/noticias/2021/diciembre/salas.png" alt="salas" class="mx-auto d-block">
        </p>
        <strong class="py-3">#YoPropongo</strong>
