  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Danos tu opinión sobre el Humboldt Fest</h3>
        
        <p class="parrafo">
          Muchas gracias a quienes participaron en nuestro evento de fin de año, Humboldt Fest, un día cargado de muchas actividades que lograron conectarnos 
          con nuestro propósito superior y encontrarnos en un espacio diferente que disfrutamos.
        </p>

        <div class="row cuadricula">
          
          <div class="col-md-4 pb-5">
            <img src="../img/galerias/humfest/2.jpg" alt="" class="img-fluid">
          </div>
          <div class="col-md-4 pb-5">
            <img src="../img/galerias/humfest/1.jpg" alt="" class="img-fluid">
          </div>
          <div class="col-md-4 pb-5">
            <img src="../img/galerias/humfest/4.jpg" alt="" class="img-fluid">
          </div>
        ...
        <p class="parrafo">
          Agradecemos y felicitamos a cada uno de los emprendimientos que participaron en el Humboldt Fest, nos genera mucha alegría saber que desde su propósito personal 
          también aportan en la sostenibilidad de nuestro País, a cada uno de los investigadores que desde su conocimiento y gestión lograron que diferentes comunidades 
          también participarán y a cada uno de ustedes por apoyarlos comprando o compartiendo con sus allegados esta experiencia.
        </p>
        <p class="parrafo">
          Valoramos el apoyo de nuestra caja de compensación Colsubsidio y a cada uno de los equipos que personas de las diferentes áreas de nuestro instituto que desde su 
          gestión hicieron que este evento fuera exitoso.
        </p>
        <div class="row cuadricula">
          
          <div class="col-md-4 pb-5">
            <img src="../img/galerias/humfest/3.jpg" alt="" class="img-fluid">
          </div>
          <div class="col-md-4 pb-5">
            <img src="../img/galerias/humfest/5.jpg" alt="" class="img-fluid">
          </div>
          <div class="col-md-4 pb-5">
            <img src="../img/galerias/humfest/6.jpg" alt="" class="img-fluid">
          </div>
          
          
        </div>
        <p class="parrafo">
          Si tienen algún comentario, sugerencia o felicitación que nos ayude a mejorar, por favor ingrese al  
          <a href="https://forms.office.com/Pages/ResponsePage.aspx?id=DQSIkWdsW0yxEjajBLZtrQAAAAAAAAAAAAO__Z0NjHVURUVEVzdOQkNMTEkxTDBVR003Wlk4RjVDMC4u" target="_blank" rel="noopener noreferrer">siguiente link</a>.
        </p>
