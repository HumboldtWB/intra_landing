  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Presentación del Marco Estratégico al 2023</h3>
        
        <br>

        <p class="parrafo" style="text-align: center;font-size:1.5em">
          <strong>Presentación:</strong>
          <iframe src="../documentos/27_SEP-JUNTA-SEP-22 .pdf" width="100%" height="500px" style="border: none;display:block; margin: 0 auto;"></iframe>
        </p>
        <br>
        <p class="parrafo" style="text-align: center;font-size:1.5em">
          <strong>Grabación de la reunión</strong>
        </p>
        <video src="../videos/GMT20221018-140938_Recording_avo_1280x720.mp4" controls style="border: none;display:block; margin: 0 auto;width: 100% ;"></video>
