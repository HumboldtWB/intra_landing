  ...
  <section style="padding-bottom:200px; text-align: justify">
    <div class="container">
      <div class="row">
        ...
        <br>
        <h3>Inducciones en Villa de Leyva</h3>

        <br>
        <strong>Conociendo nuestro propósito</strong>
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/nota_villa3.jpg" width="60%"><br>
        </div>
        <br>
La sede de Villa de Leyva es toda una experiencia, no solo por la riqueza de sus colecciones, sino por la calidez de las personas que hacen parte del equipo y que trabajan día a día por el Instituto desde el claustro San Agustín.
        <br><br>
		<div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/nota_villa1.jpg" width="60%">
        </div>
        <br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/nota_villa2.jpg" width="60%">
        </div>
        <br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/nota_villa10.jpg" width="60%">
        </div>
        <br>
Es por esto que Gestión Humana ha estado promoviendo nuevamente las inducciones del nuevo talento en la sede insignia del Instituto, donde se alberga una de las colecciones biológicas más grandes y donde se guarda celosamente lo que representa el propósito del Instituto y la razón de ser de nuestras labores diarias, la biodiversidad y la riqueza natural de nuestro país.
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/nota_villa4.jpg" width="60%">
        </div>
        <br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/nota_villa5.jpg" width="60%">
        </div>
        <br>
        En esta construcción, que data de 1573, hay gran variedad de especies: mamíferos, anfibios, reptiles y peces; todas debidamente conservadas y almacenadas para garantizar su duración en el tiempo. Además, en este claustro podrás encontrar una de las colecciones de huevos más importantes de América Latina, donada por Cornelius J. Marinkelle. Esta colección tiene huevos recolectados en varios lugares del mundo, principalmente en Canadá, Chile, Francia, Holanda, Indonesia, Inglaterra, Italia, Japón y Sudáfrica. Esta colección cuenta con aproximadamente 25 mil huevos, distribuidos en 95 familias.
        <br><br>
        <div style="text-align: center; font-size:11px">
          <img src="img/noticias/2021/agosto/nota_villa6.jpg" width="60%">
        </div>
        <br>
        <div style="text-align: center; font-size:11px">
        <img src="img/noticias/2021/agosto/nota_villa7.jpg" width="60%">        </div>
		<br><br>
        La invitación es entonces a descubrir las maravillas de nuestro claustro, a conectarnos con el propósito de nuestras labores y a visitar esta sede que está siempre abierta para todos los trabajadores, dotada de salas de juntas y espacios para el trabajo colectivo. Aprovecha las rutas a Villa de Leyva para visitar las instalaciones de Villa, una verdadera conexión vital.
        <br>
        <div style="text-align: center; font-size:11px">
        <img src="img/noticias/2021/agosto/nota_villa8.jpg" width="60%">        </div>
        <br>
        <div style="text-align: center; font-size:11px">
        <img src="img/noticias/2021/agosto/nota_villa9.jpg" width="60%">        </div>
        <br>
<br>
        <br><br>
        <br>
